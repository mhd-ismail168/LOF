...
const TextPressure = ({
    ...
    className = '',
    minFontSize = 24,
    wordColors = null // Array of colors for each word, e.g., ['#ffffff', '#14b8a6']
}) => {
    ...
    return (
        <div ref={containerRef} className="relative w-full h-full overflow-hidden bg-transparent">
            ...
            >
                {chars.map((char, i) => {
                    // Calculate which word this character belongs to
                    ...
                    if (wordColors && wordColors.length > 0) {
                        ...
                        charColor = wordColors[wordIndex % wordColors.length];
                    }
